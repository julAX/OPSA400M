...
@interface SplitViewController () {
    ...
    UINavigationController *chooseFileView, *secopsView, *attestationView, *sicopsView, *exploitView, *settingsView;
...
//        space.width = 30.;
//        
//        omaPdf.navigationItem.rightBarButtonItems = @[[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCompose target:omaPdf action:@selector(sendOmaMail)], space, omaPdf.navigationItem.rightBarButtonItem];
//        
