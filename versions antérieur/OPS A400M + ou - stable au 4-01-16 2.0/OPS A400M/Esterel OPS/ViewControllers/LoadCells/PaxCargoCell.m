...
- (void) initWithPaxCargo:(NSMutableDictionary*)dict pax:(bool)pax editable:(bool)editable
{
    ...
    self.originTextField.enabled = editable;
    self.inTextField.enabled = editable;
    self.outTextField.enabled = editable;
    self.droppedTextField.enabled = editable;
    
    UIColor *textFieldColor = (editable) ? [UIColor colorWithRed:0.0 green:122.0/255.0 blue:1.0 alpha:1.0] : [UIColor darkTextColor];
