...
-(void)setupMCBrowser{
    _browser = [[MCBrowserViewController alloc] initWithServiceType:@"missionTransfer" session:_session];
}

-(void)advertiseSelf:(BOOL)shouldAdvertise{
    if (shouldAdvertise) {
        _advertiser = [[MCAdvertiserAssistant alloc] initWithServiceType:@"missionTransfer"
                                                           discoveryInfo:nil
                                                                 session:_session];
        [_advertiser start];
    }
