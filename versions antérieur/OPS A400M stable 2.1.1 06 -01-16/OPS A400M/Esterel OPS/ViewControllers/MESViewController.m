...
- (IBAction)sendMail:(UIButton *)sender {
    ...
    if ([MFMailComposeViewController canSendMail])
    {
        ...
        [mailView setToRecipients:@[@"cedric.segard@intradef.gouv.fr",@"sebastien.wijas@intradef.gouv.fr",@"raphaelle.aucourt@intradef.gouv.fr",@"matthieu.kudela@intradef.gouv.fr",@"jerome.evrard@intradef.gouv.fr",@"guillaume.henneguez@intradef.gouv.fr"]];
