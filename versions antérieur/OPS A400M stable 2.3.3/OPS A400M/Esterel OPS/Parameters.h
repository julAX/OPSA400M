...
#define secopsMailList @[@"ba123-touraine-ops.secre.fct@intradef.gouv.fr",@"tony.fricard@intradef.gouv.fr",@"alexandra.guein@intradef.gouv.fr"]

#define CTSMailList @[@"guillaume.pineau@intradef.gouv.fr"]
