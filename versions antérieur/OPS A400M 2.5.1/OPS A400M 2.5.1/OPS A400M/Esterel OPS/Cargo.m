...
+ (void) setCargoListWithMission : (Mission *) mission {
    ...
    for(NSInteger i = 0 ; i<mission.legs.count ; i++){
        ...
        mission.legs[i][@"weightOfPax"]=@"0";
        mission.legs[i][@"weightOfPallet"] = @"0";
        mission.legs[i][@"weightOfWheeled"] = @"0";
    ...
    while(carg = [instanceEnumerator nextObject]){
        ...
        for (NSInteger i= legdep; i<=legarr; i++){
            ...
            if(carg.type==freight){
                ...
                mission.legs[i][@"weightOfPallet"]= @([mission.legs[i][@"weightOfPallet"] integerValue] + [carg.weight integerValue]).description;
                ...
                mission.legs[i][@"weightOfPax"]= @([mission.legs[i][@"weightOfPax"] integerValue] + [carg.weight integerValue]).description;
            ...
            else if(carg.type == roulant)
            {
                mission.legs[i][@"weightOfWheeled"]= @([mission.legs[i][@"weightOfWheeled"] integerValue] + [carg.weight integerValue]).description;
