...
- (void)tableView:(UITableView *)tableView willDisplayHeaderView:(UIView *)view forSection:(NSInteger)section
{
    ...
    NSDate * dateFatale1 = [NSDate dateWithTimeIntervalSinceReferenceDate:487900800];
    
    if([dateFatale1 timeIntervalSinceNow]>0){
        header.textLabel.text = @"Chic à Bahut";
    }
    else{
        header.textLabel.text = @"Chic à la jône !";
    }
