       ...
       if (!quickText)
        ...
        switch (textField.tag) {
            case 301:
                ...
                break;
            case 302:
                [quickText setValues:@[@"PCB", @"Pcb", @"PIL", @"MES", @"ASO", @"EMES", @"CE", @"TEC", @"CVA", @"ICVA", @"MED",@"PHO",@"RENS",@"CVR", @"PAX",@"Other"] pref:nil sub:nil];
                break;
            case 303:
                [quickText setValues:@[@"CTR", @"CTL"] pref:nil sub:nil];
                break;
            case 304:
                [quickText setValues:(([self cockpit]) ? @[@"PF - CM1", @"PF - CM2", @"PM - CM1", @"PM - CM2", @"CM3", @"CM4", @"BQ"] : @[@"BQ",@"CGO"]) pref:nil sub:nil];
            default:
                break;
        }
