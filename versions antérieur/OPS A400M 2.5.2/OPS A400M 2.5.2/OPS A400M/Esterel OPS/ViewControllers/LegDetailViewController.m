...
@synthesize omaCell,ctsCell,omaTitle,ctsTitle,pveCell,pveTitle;
...
- (NSInteger) tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    if(section == 2)
        ...
        return (((SplitViewController* )self.splitViewController).showTools)?9:3;
    else
        return 0;
}
...
- (void)reloadColors
{
    ...
    pveCell.backgroundColor = ([indic[@"PVE"][1] isEqualToString:@"1"])? vert : ( ([indic[@"PVE"][0] isEqualToString:@"1"])? jone2 : rouge );
    ctsCell.contentView.backgroundColor = transparant;
    omaCell.contentView.backgroundColor = transparant;
    pveCell.contentView.backgroundColor = transparant;
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section
{
    ...
    if(section==0 || section==1)
        ...
        return [NSString stringWithFormat: @"Leg %ld detailled infos",  (long)(legNumber + 1) ];
    else
        return @"Easy PVE";
