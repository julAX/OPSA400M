...
@synthesize darOnOff, fuelDensity;
...
- (void) viewWillAppear:(BOOL)animated
{
    ...
    [fuelDensity setText:([[NSUserDefaults standardUserDefaults] floatForKey:@"fuelDensity"])?[NSString stringWithFormat:@"%f",[[NSUserDefaults standardUserDefaults] floatForKey:@"fuelDensity"]]:[NSString stringWithFormat:@"%F",d]];
...
- (IBAction)fuelDensityChanged:(id)sender {
    
    [[NSUserDefaults standardUserDefaults] setFloat:[((UITextField* )sender).text floatValue] forKey:@"fuelDensity"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
@end
