...
--> LES INDICATORS :
    Dans chque leg on a mis des indicators,des "boolen" sous forme de str en 0 (pour non) et 1 (pour oui) avec pour chaque item deux "boolen" , un pour "en cours" et le deuxieme pour "fini". C'est avec ca qu'on gère tout le code couleur, vert jaune, rouge. Chic a la Jone. Voir Mission Vierge.
