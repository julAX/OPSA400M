...
- (void)viewDidLoad {
    ...
    be.delegate = self;
    na.delegate = self;
    flightRules.myDelegate = self;
    typeOfFlight.myDelegate = self;
    ...
    if (i>0) {
        ...
        switch (textField.tag) {
            case 4:
                ...
                break;
            case 5:
                [quickText setValues:@[previousLeg[@"Be"],@"W1",@"W2",@"AK",@"B4",@"BD",@"Y1",@"AX",@"AR",@"B9",@"D3",@"AC"] pref:nil sub:nil];
                break;
            case 6:
                [quickText setValues:@[previousLeg[@"Na"],@"22",@"25",@"62"] pref:nil sub:nil];
            default:
                break;
        }
        }
        if (i==0) {
            switch (textField.tag) {
                case 4:
                    ...
                    break;
                case 5:
                    [quickText setValues:@[@"W1",@"W2",@"AK",@"B4",@"BD",@"Y1",@"AX",@"AR",@"B9",@"D3",@"AC"] pref:nil sub:nil];                    break;
                case 6:
                    [quickText setValues:@[@"22",@"25",@"62"] pref:nil sub:nil];                default:
                    break;
            }
        }
