...
//                    leg[@"NightTime"]=nightTime;
        ...
        case 4002:
            if(paveDisplay4002.text.length){
                ...
                currentCargo.weight = paveDisplay4002.text; //on rentre temporairement le nombre dans le poids.
                paveDisplay4004.text = @(defaultPaxWeight).description;
        ...
        case 4004:
            if(paveDisplay4004.text.length){
                ...
                currentCargo.paxWeight = [paveDisplay4004.text integerValue];
                
                currentCargo.weight = @([currentCargo.weight integerValue]*currentCargo.paxWeight).description;
