...
-(void)loadWithData:(UIWebView*)webView{
    ...
    for (i=0; i<mission.legs.count;i++){
        ...
        [[webView valueForKeyPath:@"documentView.webView.mainFrame.javaScriptContext"] evaluateScript:[NSString stringWithFormat:@"remplir(%@,%@,'%@','%@','%@','%@',%@,%@,%@,%@,%lu)", aircraft,cdb,callSign,date,atd,@" ",engine1,engine2,engine3,engine4, (long)i]];
    }
}
