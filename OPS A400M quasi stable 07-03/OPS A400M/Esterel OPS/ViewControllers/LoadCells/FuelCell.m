...
- (void)reloadLabels
{
    ...
    self.lAddedAtDep.text = [NSString stringWithFormat:@"%.0f L", ([self.addedAtDep.text integerValue] / d)];
    self.lTotalAtTakeOff.text = [NSString stringWithFormat:@"%.0f L", ([self.totalAtTakeOff.text integerValue] / d)];
    self.lBurned.text = [NSString stringWithFormat:@"%.0f L", ([self.burned.text integerValue] / d)];
    self.lfinal.text = [NSString stringWithFormat:@"%.0f L", ([self.final.text integerValue] / d)];
    self.lreceived.text = [NSString stringWithFormat:@"%.0f L", ([self.received.text integerValue] / d)];
    self.ldelivered.text = [NSString stringWithFormat:@"%.0f L", ([self.delivered.text integerValue] / d)];
}
