...
/*
 ...
 Ici c'est le controller pour choisir les coefs de vol. On a fait en sorte de les enregistrer dans chaque leg, pour s'en souvenir a chaque fois. On bloque le nombre de coef entre 1 et 2.
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    self.title = [@"coef selection (5/" stringByAppendingString : total];
...
- (void) setButtonStates{
    ...
    switch ([leg[@"SecondCoef"] integerValue]) {
        case 2:
            on10 = YES;
            on62 = YES;
            on35 = NO;
    ...
    switch ([leg[@"FirstCoef"] integerValue]) {
        case 1:
            on10 = YES;
            break;
        case 2:
...
//Traitement des resultats. On verifie d'abord si il y a un ou deux coefs et on les stocke.
