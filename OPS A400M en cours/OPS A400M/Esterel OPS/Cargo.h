...
@property (strong, nonatomic) NSString *departure, *arrival, *be, *comment;
...
@property float paxWeight;// poids unitaire du pax

@property NSInteger nombrePax;
@property NSMutableArray *numArrnumDep;
@property BOOL absurde;
