...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section { return (section == 0) ? @"Legs" :((section == 1) ? @"End of Mission" :@"More"); }

- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView { return 3; }

- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section { return (section == 0) ? legs.count + 1 :((section == 1) ? 4: 3); }
    ...
    if (indexPath.section == 0)
    {
        ...
        switch (indexPath.row) {
            ...
            case 2:
                ...
                break;
            case 3:
                cell.textLabel.text = @"Generate PVE";
                break;
            default:
                cell.textLabel.text = @"";
                break;
    ...
    else
    {
        ...
        switch (indexPath.row) {
            ...
            case 0:
                ...
                break;
            case 1:
                cell.textLabel.text = @"Crew Feedback";
                break;
            case 2:
    ...
    if (indexPath.section == 0)
    {
        ...
        switch (indexPath.row) {
            ...
            case 2:{
                ...
                break;}
            case 3:{
                ((SplitViewController*)self.splitViewController).pdfUrl = [NSURL fileURLWithPath:[[[@"~/Documents/PVE_" stringByAppendingString: mission.legs.firstObject[@"CallSign"]] stringByAppendingString:@".pdf"] stringByExpandingTildeInPath]];
                
                [(SplitViewController*)self.splitViewController openPVEWithPreview:YES];
        ...
        switch (indexPath.row) {
            ...
            case 0:
                ...
                break;
            case 1:
                [(SplitViewController*)self.splitViewController openCrewFeedbackForm];
                break;
            case 2:
